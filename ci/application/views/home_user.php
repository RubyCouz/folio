                ...
                <div class="col s12 m6 l3">
                    <div class="card sticky-action">
                        ...
                        <div class="card-action">
                            ...
                            <input type="hidden" name="pro_id" id="pro_id<?= $element->pro_id ?>" value="<?= $element->pro_id ?>">
                            ...
                            <div class="right-align">
                                <button class="waves-effect waves-light btn addProduct" type="button" value="<?= $element->pro_id ?>">
