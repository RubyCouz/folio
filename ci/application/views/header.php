...
<html lang="fr">
    ...
    <body>
            ...
            <div class="nav-wrapper">
                ...
                <ul class="right hide-on-med-and-down">
                    ...
                    if ($this->session->userdata('id') !== null)
                    {
                        ?>
                        <li>
                            <div class="dropdown-trigger profile" href="#" data-target="dropdown_user">
                                <img src="<?= base_url('assets/img/profil_pic/' . $this->session->userdata('id') . '.' . $this->session->userdata('extension')) ?>" title="photo de profil de <?= $this->session->userdata('login') ?>" alt="photo de profil" class="tiny_pic">
        ...
        <ul class = "sidenav" id = "mobile-demo">
            <li><a href = "<?= site_url('Produits/index') ?>">Catalogue</a></li>
            <li><a href = "<?= site_url('Client/signin_form') ?>">Inscription/Connexion</a></li>
            <li><a href = "<?= site_url('Produits/sendMail') ?>">Contact</a></li>
            <li><a href = "<?= site_url('Produits/cart') ?>">Panier</a></li>
        </ul>
        ...
        <ul id="dropdown_user" class="dropdown-content dropdown_user">
            ...
            if ($this->session->userdata('role') == 1)
            {
                ...
                <li><a href = "<?= site_url('Client/check_userform') ?>">Ajouter un  utilisateurs</a></li>
                <li class = "divider" tabindex = "-1"></li>
                <li><a href = "<?= site_url('Client/update_profil/' . $this->session->userdata('id')) ?>">Mon profil</a></li>
