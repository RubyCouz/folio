        ...
        <tbody>
            ...
            foreach ($productList as $row) {
                ...
                <tr>
                    ...
                    <td><a href="<?= site_url('Produits/update') . '?pro_id=' . $row->pro_id ?>" title="Lien vers la fiche produit" class="uk-button uk-button-secondary uk-button-small">Fiche Produit</a>
                    </td>
                </tr>
                <?php
            }
