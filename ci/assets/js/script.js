...
// select
    ...
    // champs login => vérification de la présence du pseudo dans la bdd
    $('#login').keyup(function () { //  sélection du champs login et définition de l'évènement
    ...
    $('.addProduct').click(function () {
        ...
        $.post(url + 'Produits/add_product_in_cart', {// envoie des données récupérées vers le contrôleur en post
            ...
            if (data) { // si présence d'une réponse du contrôleur
                ...
                console.log(pro_qte + ', ' + pro_prix + ', ' + pro_photo + ', ' + pro_libelle + ' ' + pro_id)
            } else {
